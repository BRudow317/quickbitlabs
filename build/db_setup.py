...
def connection_string(username: str = "QBL", as_sysdba: bool = False) -> str:
    ...
    env_service = f"ORACLE_{username}_SERVICE".upper()
    ...
    logger.debug(f"Connecting as: {db_user} to {db_host}:{db_port}/{db_pdb} with SYSDBA={as_sysdba}")
    return conn_str
...
def sql_runner(
    ...
    # logger.debug("Executing SQL Command as %s:\n%s", conn_str, safe_sql)
