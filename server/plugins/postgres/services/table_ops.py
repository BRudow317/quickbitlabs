...
from server.models.PluginModels import Records
...
class PgObjType:
    ...
    def read(self, batch_size: int = 10000) -> Records:
    ...
    def filter(self, where: dict[str, Any], batch_size: int = 10000) -> Records:
    ...
    def upsert(self, records: Records, batch_size: int = 10000) -> None:
    ...
    def insert(self, records: Records, batch_size: int = 10000) -> None:
    ...
    def update_many(self, records: Records) -> int:
    ...
    def delete_many(self, records: Records) -> int:
