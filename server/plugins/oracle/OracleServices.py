...
class OracleService:
    ...
    def _column_from_row(
        ...
        # TODO: Populate is_unique (check for unique constraints)
        # TODO: Map Foreign Key standard metadata: is_foreign_key, foreign_key_entity, foreign_key_column
    ...
    def get_catalog(self, catalog: Catalog, **kwargs: Any) -> Catalog:
        ...
        TODO: Implement Silo Rule: Only return entities owned by this plugin instance.
        TODO: Implement Replacement Rule: Replace existing shallow entities with source truth.
        """
        ...
        for idx, entity in enumerate(catalog.entities):
            ...
            # TODO: Respect Replacement Rule and AST Projection strictly
            if entity.columns:
    ...
    def upsert_data(
        ...
        **kwargs: Any,
        ...
        try:
            # TODO: Implement Match Resolution Priorities 2 & 3:
            # - If operator_groups is empty, derive from PK columns.
            # - If no PKs exist, fallback to insert_data.
            # TODO: Implement Audit Alignment (auto-populate UPDATED_DATE/BY).
            target = _get_target_entity(catalog)
    ...
    def create_entity(self, catalog: Catalog, **kwargs: Any) -> Entity:
        ...
        TODO: Autonomously inject "Managed Entity" boilerplate:
        - Surrogate PK: <TABLE>_ID NUMBER GENERATED BY DEFAULT AS IDENTITY.
        - Audit Columns: CREATED_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY.
        """
        if not catalog.entities:
            raise ValueError("Catalog must contain at least one entity.")
        schema_name = self._resolve_schema(catalog)
