...
_CREATE_PLUGIN_CATALOG_REGISTRY = """
CREATE TABLE PLUGIN_CATALOG_REGISTRY (
    PLUGIN_CATALOG_REGISTRY_ID  NUMBER
                                     GENERATED BY DEFAULT AS IDENTITY
                                     CONSTRAINT PK_PLUGIN_CATALOG_REGISTRY PRIMARY KEY,

    PLUGIN_NAME                 VARCHAR2(100 CHAR)               NOT NULL,
    SCOPE                       VARCHAR2(20 CHAR)  DEFAULT 'SYSTEM' NOT NULL,
    SOURCE_TYPE                 VARCHAR2(100 CHAR),
    CATALOG_JSON                CLOB                             NOT NULL,
    LAST_SYNCED_AT              TIMESTAMP WITH TIME ZONE         NOT NULL,

    CONSTRAINT UQ_PCR_PLUGIN_NAME UNIQUE (PLUGIN_NAME),
