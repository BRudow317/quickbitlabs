...
class PluginResponse(BaseModel, Generic[T]):
    """
_codes = {
    # Informational.
    100: ("continue",),
    ...
    """
    ok: bool = False
    data: SkipValidation[T] | None = None
    code: int = 500
    message: str = ''
    ...
    @classmethod
    def success(cls, data: T, message: str = '') -> PluginResponse[T]:
        return cls(ok=True, data=data, code=200, message=message)

    @classmethod
    def not_found(cls, message: str, data: Any = None) -> PluginResponse[Any]:
